...
import * as Plugin_0 from 'C:/Users/GIGABYTE/admission-system/frontend/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'C:/Users/GIGABYTE/admission-system/frontend/src/app.tsx',
    },
    {
      apply: Plugin_1,
